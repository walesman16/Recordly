...
### 制作精致、专业级的屏幕录制内容。
[Recordly](https://www.recordly.dev) 是一款开源的录屏与编辑工具，适用于演示、产品展示、教程、讲解视频和社交短片。你可以录制整个屏幕或单个窗口，直接进入编辑器，并通过光标特效、缩放、背景、注释、摄像头叠加等功能导出更完整的成片。
...
> [!NOTE]
> 感谢许多人的支持，这些支持帮助 Recordly 持续保持开源和免费！
[**支持项目**](https://ko-fi.com/webadderall/goal?g=0)

> 这个 CA 产生的交易手续费也会用于 Recordly 的开发：
...
Recordly 是一款桌面应用，用于录制并编辑屏幕内容，内置了适合演示视频的动态呈现工具。你不需要先导出原始录像，再切换到其他编辑器去补缩放、光标润色或背景样式，Recordly 会在一个地方完成整个工作流。
...
Recordly 最初是从优秀的 [OpenScreen](https://github.com/siddharthvaddem/openscreen) 项目分叉而来，随后已经经过了大量修改。
